    ...
    var b = "undefined" !== typeof window && "undefined" !== typeof window.document ? window.document : {},
        ...
        a = function() {
            for (var a, c = ["requestFullscreen exitFullscreen fullscreenElement fullscreenEnabled fullscreenchange fullscreenerror".split(" "), "webkitRequestFullscreen webkitExitFullscreen webkitFullscreenElement webkitFullscreenEnabled webkitfullscreenchange webkitfullscreenerror".split(" "),
                ...
                ], g = 0, d = c.length, e = {}; g < d; g++)
                if ((a = c[g]) && a[1] in b) {
                    for (g = 0; g < a.length; g++) e[c[0][g]] =
                        a[g];
                    return e
                }
            return !1
...
TEXT_CLEAR_LAST_BET = "UNDO BET";
TEXT_CLEAR_ALL_BET = "CLEAR BET";
...
TEXT_DISPLAY_MSG_WAITING_BET = "PLEASE\n BET";
TEXT_SPINNING = "PLEASE WAIT...";
TEXT_DISPLAY_MSG_PLAYER_WIN = "WIN ";
TEXT_DISPLAY_MSG_PLAYER_LOSE = "NO WIN";
...
function CMain(b) {
    ...
    this._loadImages = function() {
        ...
        s_oSpriteLibrary.addSprite("enlight_second_twelve",
            "./sprites/enlight_second_twelve.png");
        ...
        s_oSpriteLibrary.addSprite("circle_black",
            "./sprites/circle_black.png");
        ...
        for (b = 0; b < NUM_MASK_BALL_SPIN_FRAMES; b++) s_oSpriteLibrary.addSprite("wheel_anim_" + b, "./sprites/wheel_anim/wheel_anim_" +
            b + ".jpg");
        for (b = 0; b < NUM_WHEEL_TOP_FRAMES; b++) s_oSpriteLibrary.addSprite("wheel_top_" + b, "./sprites/wheel_top/wheel_top_" + b + ".jpg");
...
function CTextButton(b, f, e, a, d, c, h, k) {
    ...
    this._init = function(a, b, c, d, e, f, h) {
        ...
        r = createBitmap(c);
        l.addChild(r);
        v = new CTLText(l, 0, 0, c.width, c.height, h, "center", f, e, 1, 2, 2, d, !0, !0, !1, !1);
        this._initListener()
    };
    this.unload = function() {
        l.off("mousedown", u);
    ...
    this.tweenPosition = function(a, b, c, r, d, v, e) {
...
function CBetTextButton(b, f, e, a, d, c, h, k) {
    ...
    this._init = function(a, b, c, d, e, f, k, h) {
        g = !1;
        v = [];
        r = [];
        n = c.width;
        ...
        D = createBitmap(c);
        y.addChild(D);
        z = new CTLText(y, 0, 0, c.width, c.height, k, "center", f, e, 1, 2, 2, d, !0, !0, !1, !1);
        this._initListener();
        A = h;
        l = [];
        l = h.split("_");
...
function CGame(b) {
          ...
          success: function(data) {
           if(data.status == 1) {
            if (typeof data.credit !== 'undefined') {
             r.setCredit(data.credit);
             z.refreshMoney(data.credit);
             resync = 0;
            }
           }
           else {
        ...
        for (var v = 0; v < a.length; v++) {
            ...
            if (0 < e.win)
                for (var f = 0; f < e.mc.length; f++) {
                    A.push(e.mc[f]);
                    var g = s_oGameSettings.getAttachOffset("oDealerWin");
                    e.mc[f].setEndPoint(g.x, g.y)
                }
        }
        if (b.mc) {
            for (a = 0; a < b.mc.length; a++) g = s_oGameSettings.getAttachOffset("oReceiveWin"), b.mc[a].setEndPoint(g.x, g.y);
            z.showWin(d)
        } else z.showLose();
    ...
    this.onSpin = function() {
        ...
        $(r.getNumbersBetted()).each(function(key, value) {
         bet[key] = value.win;
        });
        
        $.ajax({
         url : IC_WEBGAMES_SERVER + '/roulette.php',
         type : 'POST',
         data :  {
          sid: IC_SID,
          token: IC_TOKEN ,
    ...
    this._onShowBetOnTable = function(a, b) {
        ...
        var e = a.bet_win,
            f = a.num_fiches;
        if (b) var g = a.value;
        else g = z.getCurFicheSelected(), 0 === t.length && (l = [], z.disableRebet()), l.push({
            button: a.button,
            numbers: a.numbers,
            bet_mult: a.bet_mult,
            bet_win: a.bet_win,
        ...
        if (0 > r.getCredit() - h * f) I.show(TEXT_ERROR_NO_MONEY_MSG),
            ...
            switch (c) {
                case "oBetVoisinsZero":
                    r.addFicheOnTable(h, g, [0, 2, 3], 12, "bet_0_2_3");
                    r.addFicheOnTable(h, g, [0, 2, 3], 12, "bet_0_2_3");
                    r.addFicheOnTable(h, g, [4, 7], 18, "bet_4_7");
                    r.addFicheOnTable(h, g, [12, 15], 18, "bet_12_15");
                    r.addFicheOnTable(h, g, [19, 22], 18, "bet_19_22");
                    r.addFicheOnTable(h, g, [25, 26, 28, 29], 9, "bet_25_26_28_29");
                    r.addFicheOnTable(h, g, [25, 26, 28, 29], 9, "bet_25_26_28_29");
                    r.addFicheOnTable(h, g, [32, 35], 18, "bet_32_35");
                    break;
                case "oBetTier":
                    r.createPileForTier(h, g, v, e, f);
                    break;
                case "oBetOrphelins":
                    r.addFicheOnTable(h, g, [1], 36, "bet_1");
                    r.addFicheOnTable(h, g, [6, 9], 18, "bet_6_9");
                    r.addFicheOnTable(h, g, [14, 17], 18, "bet_14_17");
                    r.addFicheOnTable(h, g, [17, 20], 18, "bet_17_20");
                    r.addFicheOnTable(h, g, [31, 34], 18, "bet_31_34");
                    break;
                case "oBetFinalsBet":
                    r.createPileForMultipleNumbers(h, g, v, e, f);
                    break;
                default:
                    r.addFicheOnTable(h, g, v, e, c)
            }
            z.refreshMoney(r.getCredit());
            z.enableSpin(!0);
            playSound("chip", 1, !1)
    ...
    this._onShowBetOnTableFromNeighbors =
        function(a, b) {
            ...
            g * e > r.getCredit() ? (I.show(TEXT_ERROR_NO_MONEY_MSG), F.reset()) : (r.createPileForMultipleNumbers(g, a.value, c, v, e), z.refreshMoney(r.getCredit()),
...
function CInterface() {
    ...
    this._init = function() {
        ...
        bfs=s_oSpriteLibrary.getSprite("but_fullscreen");
        
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) {
            var e = s_oSpriteLibrary.getSprite("audio_icon")
            d = new CToggle(e.width / 2 + 5, e.height / 2 + 5, e, s_bAudioActive, s_oStage);
            d.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
            var I = d.getX() + (e.width / 2) + 5;
            var H = d.getY()
        } else {
         var I = bfs.width / 2 + 5;
         var H = bfs.height / 2 + 5;
        }
        e = window.document;
        ...
        z && screenfull.enabled && (e = bfs, y = new CToggle(I, H, e, s_bFullscreen, s_oStage), y.addEventListener(ON_MOUSE_UP, this._onFullscreenRelease, this))
    };
    this.unload = function() {
...
function CWheelTopAnim(b, f) {
    ...
    this._init = function(b, g) {
        ...
        s_oStage.addChild(h);
        a = [];
        for (var f = 0; f < NUM_WHEEL_TOP_FRAMES; f++) {
            var k = createBitmap(s_oSpriteLibrary.getSprite("wheel_top_" + f));
            k.visible = !1;
            h.addChild(k);
            a.push(k)
        }
