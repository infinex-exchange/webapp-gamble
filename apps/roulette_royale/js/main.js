...
function CGame(a) {
    ...
    this._init = function() {
        ...
        n.setCredit(initialCredit);
        w.setMoney(initialCredit);
    }
    ...
    this.onSpin = function() {
        ...
        parent.bioRequest(
            ...
            function(data) {
                k = data.k;
                0 !== n.getCurBet() && (n.getCurBet() < MIN_BET ? (A.show(TEXT_ERROR_MIN_BET), w.enableBetFiches(), w.enableSpin(!0)) : w.isBlockVisible() || (w.showBlock(), F.hide(), I.hide(), w.enableSpin(!1), obj._startRouletteAnim(), obj._startBallSpinAnim(), $(s_oMain).trigger("bet_placed", n.getCurBet()), obj._setState(STATE_GAME_SPINNING), playSound("wheel_sound", 1, !1)))
            }
        );
    };
...
function CInterface() {
    var a, d, f, h, b, m, k, e, l, c, u = null,
        x = null,
    ...
    this._init = function() {
        ...
        if (!1 === DISABLE_SOUND_MOBILE || !1 === s_bMobile) B = s_oSpriteLibrary.getSprite("audio_icon"), b = CANVAS_WIDTH - B.width / 2 - 10, m = B.height / 2 + 10, l = new CToggle(b, m, B, s_bAudioActive, s_oStage), l.addEventListener(ON_MOUSE_UP, this._onAudioToggle, this);
        B = window.document;
        G = B.documentElement;
    ...
    this.setMoney = function(a) {
        t.refreshText(a.toFixed(0))
    };
    this.setCurBet = function(a) {
        v.refreshText(a.toFixed(0))
    };
...
function CNeighborsPanel() {
    ...
    this._init = function() {
        ...
        q.addChild(a);
        v = new createjs.Text(f, "20px " + FONT1, "#fff");
        v.textAlign = "center";
        v.x = 690;
        v.y =
            564;
